            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="intro-text">
                        ...
                        <hr class="star-light">
                        <span class="skills">Travel - Explore - Learn</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="footer-col col-md-4">
                        <h3>Location</h3>
                        <p>Ganga Hall , Balaju<br>Kathmandu , Nepal</p>
                    </div>
                    <div class="footer-col col-md-4">
                        <h3>Find me at</h3>
                        <ul class="list-inline">
                            <li>
                                <a href="https://facebook.com/ezerames" class="btn-social btn-outline"><i class="fa fa-fw fa-facebook"></i></a>
                            </li>
                            <li>
                                <a href="https://google.com/+EzerRamesNeupane3" class="btn-social btn-outline"><i class="fa fa-fw fa-google-plus"></i></a>
                            </li>
                            <li>
                                <a href="https://twitter.com/ezerames" class="btn-social btn-outline"><i class="fa fa-fw fa-twitter"></i></a>
                            </li>
                            <li>
...
{{--                             <li>
        ...
        <div class="footer-below">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        Copyright &copy; ezer3cipher 2015
                    </div>
                </div>
            </div>
        </div>
